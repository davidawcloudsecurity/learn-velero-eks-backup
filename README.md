...
get_cluster_details() {
  ...
  export cluster_role=$(aws iam list-roles --query "Roles[*].RoleName" | grep "eks-cluster" | sed 's/[",]//g')
  export fargate_role=$(aws iam list-roles --query "Roles[*].RoleName" | grep "eks-cluster" | sed 's/[",]//g')
